...
public class PkLoginVelocity {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) {
        ...
        // MiniPlaceholders integration (soft dependency)
        if (server.getPluginManager().getPlugin("miniplaceholders").isPresent()) {
            com.pumpkiiings.pklogin.velocity.placeholder.PkLoginMiniVelocityExpansion.register(this);
            logger.info("MiniPlaceholders found - placeholders registered.");
        }
    }
