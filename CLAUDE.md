...
> "Triage issues from {{REPO_NAME}}, last 15"
→ Categorizes, labels, suggests responses
```

### 4. Web Pages & UI Design
**Load**: 
- `view .claude/skills/ui-styling/SKILL.md`
- `view .claude/skills/ui-ux-pro-max/SKILL.md`
- `view .claude/skills/frontend-design/SKILL.md`

**Use cases**:
- "Build a landing page for a SaaS product"
- "Create a responsive web dashboard"
- "Style these HTML components"

**Example**:
```
> view .claude/skills/ui-ux-pro-max/SKILL.md
> "Build a landing page for my beauty spa"
→ Generates tailored design system and UI code
```
